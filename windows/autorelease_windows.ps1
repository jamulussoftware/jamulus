...
echo "Get Qt 64 bit..."
aqt install --outputdir C:\Qt 5.15.2 windows desktop win64_msvc2019_64 -b https://mirrors.ocf.berkeley.edu/qt/
echo "Get Qt 32 bit..."
aqt install --outputdir C:\Qt 5.15.2 windows desktop win32_msvc2019 -b https://mirrors.ocf.berkeley.edu/qt/
