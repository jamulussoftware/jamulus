...
win32 {
    ...
    contains(CONFIG, "server_bundle") {
        ...
        MACOSX_BUNDLE_ICON.files = src/res/jamulus-server-icon-2020.icns
        RC_FILE = src/res/jamulus-server-icon-2020.icns
    } else {
        MACOSX_BUNDLE_ICON.files = src/res/mainicon.icns
...
SOURCES += src/sound/oboe/sound.cpp \
    ...
    contains(CONFIG, "headless") {
        ...
        icons.path = $$ICONSDIR
        icons.files = src/res/jamulus-deb.png
...
DISTFILES += ChangeLog \
    ...
    src/res/jamulus-deb.png \
    src/res/jamulus-icon-2020.svg \
    src/res/jamulus-server-icon-2020.svg \
