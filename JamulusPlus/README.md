...
This folder is the authoritative JUCE/non-Qt build root for JamulusPlus. It builds the non-Qt core API, the JUCE plugin targets, and the standalone target from one CMake tree.
...
- Use `JamulusPlus\\b` as the default local build directory.

Build:

```powershell
cd "E:/Web stuff/Jamulus VST Wrapper - ALL Workking and Finished - QT working Version/jamulus/JamulusPlus"
