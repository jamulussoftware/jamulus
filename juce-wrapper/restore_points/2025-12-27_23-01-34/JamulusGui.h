...
public:
    ...
    void resized() override
    {
        ...
        // Solo / Mute at bottom
        auto bottomArea = bounds.removeFromBottom ( 58 );
        soloButton.setBounds ( bottomArea.removeFromTop ( 29 ).reduced ( 10, 2 ) );
        muteButton.setBounds ( bottomArea.removeFromTop ( 29 ).reduced ( 10, 2 ) );
...
public:
    ...
    ~JamulusGuiComponent() override { stopTimer(); }
...
private:
    ...
    void popOutChat()
    {
        ...
        chatWindow->onWindowClosed = [this]() { chatWindow.reset(); };
