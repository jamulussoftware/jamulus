...
public:
    ...
    static QLocale::Country LocaleQt5toQt6 ( const QLocale::Country eCountry );
    static QLocale::Country LocaleQt6toQt5 ( const QLocale::Country eCountry );
    ...
    constexpr struct slocalestruct const static slocaletab[262] = {
        { 0, 0, "." },      { 1, 1, "af" },     { 3, 248, "ax" },   { 4, 2, "al" },     { 5, 3, "dz" },     { 6, 4, "." },      { 7, 5, "ad" },
        { 8, 6, "ao" },     { 9, 7, "." },      { 10, 8, "." },     { 11, 9, "." },     { 12, 10, "ar" },   { 13, 11, "am" },   { 15, 12, "aw" },
        { 16, 247, "." },   { 17, 13, "au" },   { 18, 14, "at" },   { 19, 15, "az" },   { 20, 16, "." },    { 21, 17, "bh" },   { 22, 18, "bd" },
        { 23, 19, "." },    { 24, 20, "by" },   { 25, 21, "be" },   { 26, 22, "." },    { 27, 23, "bj" },   { 28, 24, "." },    { 29, 25, "bt" },
        { 30, 26, "bo" },   { 31, 27, "ba" },   { 32, 28, "bw" },   { 33, 29, "." },    { 35, 30, "br" },   { 36, 31, "." },    { 37, 233, "." },
        { 38, 32, "bn" },   { 39, 33, "bg" },   { 40, 34, "bf" },   { 41, 35, "bi" },   { 43, 36, "kh" },   { 45, 37, "cm" },   { 46, 38, "ca" },
        { 48, 238, "." },   { 49, 39, "cv" },   { 50, 255, "." },   { 51, 40, "." },    { 53, 41, "cf" },   { 54, 250, "." },   { 55, 42, "td" },
        { 57, 43, "cl" },   { 56, 44, "cn" },   { 58, 45, "." },    { 59, 241, "." },   { 118, 46, "." },   { 60, 47, "co" },   { 61, 48, "km" },
        { 63, 50, "cd" },   { 64, 49, "cg" },   { 65, 51, "." },    { 67, 52, "cr" },   { 68, 54, "hr" },   { 69, 55, "cu" },   { 232, 152, "." },
        { 70, 56, "cy" },   { 71, 57, "cz" },   { 72, 58, "dk" },   { 73, 249, "." },   { 74, 59, "dj" },   { 75, 60, "." },    { 77, 61, "do" },
        { 80, 63, "ec" },   { 81, 64, "eg" },   { 82, 65, "sv" },   { 83, 66, "gq" },   { 84, 67, "er" },   { 100, 68, "ee" },  { 85, 204, "sz" },
        { 86, 69, "et" },   { 87, 261, "." },   { 88, 258, "." },   { 89, 70, "." },    { 90, 71, "fo" },   { 91, 72, "." },    { 92, 73, "fi" },
        { 93, 74, "fr" },   { 94, 76, "gf" },   { 95, 77, "pf" },   { 96, 78, "." },    { 97, 79, "ga" },   { 98, 80, "." },    { 99, 81, "ge" },
        { 102, 82, "de" },  { 101, 83, "gh" },  { 103, 84, "." },   { 104, 85, "gr" },  { 105, 86, "gl" },  { 106, 87, "." },   { 107, 88, "gp" },
        { 108, 89, "." },   { 109, 90, "gt" },  { 110, 75, "." },   { 111, 92, "gw" },  { 112, 91, "gn" },  { 113, 93, "gy" },  { 114, 94, "." },
        { 116, 95, "." },   { 117, 96, "hn" },  { 119, 97, "hk" },  { 120, 98, "hu" },  { 122, 99, "is" },  { 123, 100, "in" }, { 124, 101, "id" },
        { 125, 102, "ir" }, { 174, 103, "iq" }, { 218, 104, "ie" }, { 127, 251, "." },  { 128, 105, "il" }, { 129, 106, "it" }, { 131, 53, "ci" },
        { 132, 107, "." },  { 133, 108, "jp" }, { 134, 252, "." },  { 135, 109, "jo" }, { 136, 110, "kz" }, { 137, 111, "ke" }, { 138, 112, "." },
        { 139, 257, "." },  { 140, 115, "kw" }, { 141, 116, "kg" }, { 142, 117, "la" }, { 143, 246, "." },  { 144, 118, "lv" }, { 145, 119, "lb" },
        { 146, 120, "ls" }, { 147, 121, "." },  { 148, 122, "ly" }, { 149, 123, "li" }, { 150, 124, "lt" }, { 151, 125, "lu" }, { 152, 126, "mo" },
        { 153, 127, "mk" }, { 154, 128, "mg" }, { 155, 129, "." },  { 156, 130, "my" }, { 158, 131, "." },  { 159, 132, "ml" }, { 160, 133, "mt" },
        { 161, 134, "." },  { 162, 135, "mq" }, { 163, 136, "mr" }, { 164, 137, "mu" }, { 165, 138, "yt" }, { 62, 139, "mx" },  { 166, 140, "." },
        { 167, 141, "md" }, { 168, 142, "mc" }, { 170, 143, "mn" }, { 169, 242, "me" }, { 171, 144, "." },  { 172, 145, "ma" }, { 173, 146, "mz" },
        { 175, 147, "mm" }, { 176, 148, "na" }, { 178, 149, "." },  { 179, 150, "np" }, { 180, 151, "nl" }, { 181, 153, "nc" }, { 182, 154, "nz" },
        { 183, 155, "ni" }, { 184, 157, "ng" }, { 185, 156, "ne" }, { 186, 158, "." },  { 187, 159, "." },  { 188, 160, "." },  { 189, 113, "kp" },
        { 190, 161, "no" }, { 191, 162, "om" }, { 192, 259, "." },  { 193, 163, "pk" }, { 194, 164, "." },  { 197, 165, "ps" }, { 198, 166, "pa" },
        { 201, 167, "pg" }, { 202, 168, "py" }, { 203, 169, "pe" }, { 204, 170, "ph" }, { 205, 171, "." },  { 206, 172, "pl" }, { 208, 173, "pt" },
        { 209, 174, "pr" }, { 210, 175, "qa" }, { 212, 176, "re" }, { 213, 177, "ro" }, { 214, 178, "ru" }, { 215, 179, "rw" }, { 216, 244, "." },
        { 217, 199, "." },  { 220, 180, "." },  { 221, 181, "." },  { 196, 245, "." },  { 200, 200, "." },  { 222, 182, "." },  { 223, 183, "." },
        { 224, 184, "sm" }, { 76, 185, "st" },  { 225, 186, "sa" }, { 226, 187, "sn" }, { 227, 243, "rs" }, { 228, 188, "sc" }, { 229, 189, "sl" },
        { 230, 190, "sg" }, { 231, 256, "." },  { 233, 191, "sk" }, { 234, 192, "si" }, { 235, 193, "." },  { 236, 194, "so" }, { 238, 195, "za" },
        { 239, 196, "." },  { 240, 114, "kr" }, { 241, 254, "." },  { 242, 197, "es" }, { 243, 198, "lk" }, { 244, 201, "sd" }, { 245, 202, "sr" },
        { 246, 203, "." },  { 248, 205, "se" }, { 247, 206, "ch" }, { 250, 207, "sy" }, { 251, 208, "tw" }, { 252, 209, "tj" }, { 253, 210, "tz" },
        { 254, 211, "th" }, { 255, 62, "tl" },  { 34, 212, "tg" },  { 249, 213, "." },  { 256, 214, "to" }, { 257, 215, "." },  { 259, 253, "." },
        { 42, 216, "tn" },  { 260, 217, "tr" }, { 261, 218, "." },  { 52, 219, "." },   { 157, 220, "." },  { 207, 221, "ug" }, { 195, 222, "ua" },
        { 199, 223, "ae" }, { 130, 224, "gb" }, { 14, 226, "." },   { 2, 225, "us" },   { 66, 234, "." },   { 47, 227, "uy" },  { 115, 228, "uz" },
        { 121, 229, "." },  { 237, 230, "." },  { 219, 231, "ve" }, { 44, 232, "vn" },  { 211, 235, "." },  { 126, 236, "eh" }, { 79, 260, "." },
        { 177, 237, "ye" }, { 258, 239, "zm" }, { 78, 240, "." } };
#endif
};
