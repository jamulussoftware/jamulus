...
LangString DESKTOP_SET_SHORTCUT ${LANG_FRENCH} \
    "Créer un raccourci sur le bureau"

LangString INVALID_FOLDER_MSG ${LANG_FRENCH} \
    "Le dossier de destination existe déjà. Veuillez entrer un nouveau dossier de destination."

LangString RUNNING_APP_MSG ${LANG_FRENCH} \
...
LangString ASIO_DRIVER_HEADER ${LANG_FRENCH} \
     "Pilote ASIO"
...
LangString ASIO_DRIVER_MORE_INFO_URL ${LANG_FRENCH} \
