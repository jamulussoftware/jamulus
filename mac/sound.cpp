...
void CSound::GetAvailableInOutDevices()
{
    ...
    {
        throw CGenErr ( QCoreApplication::translate ( "global",
                                                      "No sound card is available in your system. "
    ...
    {
        throw CGenErr ( QCoreApplication::translate ( "global",
                                                      "No sound card is available in the system. "
...
QString CSound::LoadAndInitializeDriver ( QString strDriverName, bool )
{
    ...
    {
        return QCoreApplication::translate ( "global", "The currently selected audio device is no longer present. Please check your audio device." );
    }
...
QString CSound::CheckDeviceCapabilities ( const int iDriverIdx )
{
    ...
    if ( AudioObjectGetPropertyData ( audioInputDevice[iDriverIdx], &stPropertyAddress, 0, NULL, &iPropertySize, &inputSampleRate ) )
    {
        return QString ( QCoreApplication::translate (
            "global",
            "The audio input device is no longer available. Please check if your input device is connected correctly." ) );
    }
    ...
    if ( inputSampleRate != fSystemSampleRate )
    {
             ...
             noErr )
        {
            return QString ( QCoreApplication::translate ( "global",
                                                           "The sample rate on the current input device isn't %1 Hz and is therefore incompatible. "
    ...
    if ( AudioObjectGetPropertyData ( audioOutputDevice[iDriverIdx], &stPropertyAddress, 0, NULL, &iPropertySize, &outputSampleRate ) )
    {
        return QString ( QCoreApplication::translate (
            "global",
            "The audio output device is no longer available. Please check if your output device is connected correctly." ) );
    }
    ...
    if ( outputSampleRate != fSystemSampleRate )
    {
        ...
        {
            return QString ( QCoreApplication::translate ( "global",
                                                           "The sample rate on the current output device isn't %1 Hz and is therefore incompatible. "
                                                           "Please select another device or try setting the sample rate to %1 Hz "
                                                           "manually via Audio-MIDI-Setup (in Applications->Utilities)." ) )
                .arg ( SYSTEM_SAMPLE_RATE_HZ );
        }
    ...
    {
        return QString ( QCoreApplication::translate ( "global",
                                                       "The stream format on the current input device isn't "
    ...
    {
        return QString ( QCoreApplication::translate ( "global",
                                                       "The stream format on the current output device isn't "
...
int CSound::Init ( const int iNewPrefMonoBufferSize )
{
    ...
    const QString strErrBufSize = QCoreApplication::translate ( "global",
