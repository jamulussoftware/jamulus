...
LangString ASIO_DRIVER_SUB ${LANG_KOREAN} \
...
LangString JACK_EXIT_NO_DRIVER ${LANG_KOREAN} \
     "이 ${APP_NAME} 버전이 작동하려면 JACK 오디오 연결 키트가 필요합니다, 하지만 사용자의 PC에는 설치되지 않은 것 같습니다. 먼저 Windows 용 JACK을 설치하세요. 그래도 JACK을 설치하지 않은 채 먼저 ${APP_NAME}을 설치하시겠습니까?"
