...
## Connecting to the JSON-RPC server

On **Linux**, you can use the `nc` CLI tool. 

On **Windows**, you can download and use the `ncat` CLI tool. 

To control the JSON-RPC server programmatically, you can use a package like [jayson](https://www.npmjs.com/package/jayson) for Node.js line this:
