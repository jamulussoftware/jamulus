...
!define MUI_ICON                       "${ROOT_PATH}\src\res\mainicon.ico"
!define MUI_UNICON                     "${ROOT_PATH}\src\res\mainicon.ico"
!define SERVER_ICON                    "${ROOT_PATH}\src\res\jamulus-server-icon-2020.ico"
